...
const CriNav = () => {
  ...
  return (
    <div className='w-full primarycolor shadow-sm'>
      ...
      {/* Off-canvas Sidebar */}
      <div
        className={`fixed top-0 z-10 right-0 h-full w-80 bg-gray-700 text-white shadow-lg transform transition-transform duration-300 ${
